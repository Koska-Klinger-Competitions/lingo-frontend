...
export const RightBar = () => {
	...
	const [hearts, setHearts] = useAtom(heartAtom); 
		...
		<>
			<aside className="sticky top-0 hidden w-96 flex-col gap-6 self-start sm:flex">
				<article className="my-6 flex justify-between gap-4">
					<div
						className="relative flex cursor-default items-center gap-2 rounded-xl p-3 font-bold text-gray-500 hover:bg-gray-100"
					...
					>
						...
						<div
							className="absolute left-0 top-full z-10 rounded-2xl border-2 border-gray-300 bg-white"
							style={{
								width: 300,
					...
					>
						...
						<div
							className="absolute right-0 top-full z-10 flex flex-col gap-5 rounded-2xl border-2 border-gray-300 bg-white p-5 text-black"
							style={{
								right: "0px",
								width: 400,
...
const CreateAProfileSection = ({
	...
	return (
		<article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold">
			...
			<button
				className="rounded-2xl border-b-4 border-fuchsia-600 bg-fuchsia-500 py-3 uppercase text-white transition hover:border-fuchsia-500 hover:bg-fuchsia-400"
