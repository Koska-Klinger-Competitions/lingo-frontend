import { DoneSvg, BigCloseSvg } from "~/components/Svgs";
...
export default function CheckAnswer({
	...
	return (
		<>
			<section className="border-gray-200 sm:border-t-2 sm:p-10 fixed bottom-0 left-0 right-0">
				<div className="mx-auto flex max-w-5xl p-4 sm:p-0 sm:justify-between">
					<button
			...
			<div
				className={
					correctAnswerShown
						? isAnswerCorrect
							? "fixed bottom-0 left-0 right-0 bg-sky-100 font-bold text-blue-600 transition-all"
