...
const ProfileTopSection = () => {
  ...
  return (
    <section className="flex flex-row-reverse border-b-2 border-gray-200 pb-8 md:flex-row md:gap-8">
      ...
      <div className="flex grow flex-col justify-between gap-3 mt-10">
...
const ProfileStatsSection = () => {
  ...
  const totalXp = useBoundStore((x) => x.totalXp);
  const league = "Bronze";
        ...
        <div className="flex items-center justify-center py-10 text-center text-gray-500">
          {state === "FOLLOWING"
            ? <div className="flex flex-col gap-4">
                <img src="/sad_cookie_monster.png" />
                <h3 className="block">Oh no, you have no friends ):</h3>
            </div>
            : "No followers yet"}
        </div>
      </div>
